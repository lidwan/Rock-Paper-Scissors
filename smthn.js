...
function playRound () {
    ...
    //loop to keep asking for a choice until there's a winner, if there's a tie, the loop will run again.
    while(tie){
...
//instructions generated by copilot because I'm too lazy to write them myself ;)
console.log("%cInstructions:","font-size: large; color: red;");
console.log("%cWelcome to the rock, paper, scissors game! First to reach 5 points wins!","font-size: large; color: blue;");
console.log("%cYou will be asked to choose rock, paper or scissors, the computer will choose randomly and the winner will be decided based on the rules of the game.","font-size: large;");
console.log("%cGood luck!","font-size: large;");
console.log("%cStarting the game in 5 seconds...","font-size: large;");

//starting the game after 5 seconds to give the user time to read the instructions and acount browser's delay.
